...
declare variable $editionID as xs:string := '74338567';
...
declare variable $workID as xs:string := 'opera_work_9ca65f23-9dc2-487b-b012-1e6e13c3dbe9_exp1';
...
(: Vogelhändler: B :)
declare variable $referenceSourceID as xs:string := 'opera_source_af56ff93-664f-4df2-817c-5ad6d826e850';
...
declare function local:getSourceSiglaFromCSV($concRawData, $connectionType) {
    ...
    else (tokenize($concRawData[1], ';')[position() > 5 and position() < 10])
};
                                                                ...
                                                                return
                                                                    ...
                                                                    return
                                                                        ...
                                                                        then (
                                                                            ...
                                                                            (:
                                                                            let $participant := $participantSource//mei:measure[.//ancestor::mei:mdiv[@label = normalize-space(substring-before($p, ':'))]][@n = normalize-space(substring-after($p, ':'))]
                                                                            return 
                                                                                if (count($participant) = 1)
                                                                                then ()
                                                                                else ($participantSource//mei:measure[.//descendant::mei:mdiv[@label = normalize-space(substring-before($p, ':'))]][@n = normalize-space(substring-after($p, ':'))])
                                                                            :)
                                                                        )
                                                                        else (
...
(:                                                                normalize-space(substring-before($connectionParticipantNo, ':')):)
                                                        ...
                                                        else if ($participantSource/mei:mei/@xml:id = 'opera_source_987507b4-a1ac-4de4-a9bb-173ea86d8449')
                                                        then (
                                                            if (contains($connectionParticipantNo, ','))
                                                            then (
                                                                let $connectionParticipantNoT := tokenize($connectionParticipantNo, ', ')
                                                        ...
                                                        (: Steffani: opera_edition_034306b9-b622-4a69-b072-b06e4bb86dd9: ME; opera_source_a8ee1f84-fc0f-4d21-a56f-72e4f93f91c4: A; edirom_source_947bf706-3c36-41fd-9f09-5b995d067a74: B :)
                                                        else if (($participantSource/mei:mei/@xml:id = 'opera_edition_034306b9-b622-4a69-b072-b06e4bb86dd9' or $participantSource/mei:mei/@xml:id = 'opera_source_a8ee1f84-fc0f-4d21-a56f-72e4f93f91c4' or $participantSource/mei:mei/@xml:id = 'edirom_source_947bf706-3c36-41fd-9f09-5b995d067a74') and contains($connectionParticipantNo, ','))
                                                        then (
...
(:                                                                        $participantSource//mei:measure[@n = normalize-space($p)]:)
                                                        ...
                                                        (: LiaV: opera_edition_3578ef42-491f-4bc1-a426-728553f3cdba: ME; opera_source_786a4e99-aacd-459d-a40a-79c894e92497: A :)
                                                        (: Steffani: opera_edition_034306b9-b622-4a69-b072-b06e4bb86dd9, ME; opera_source_a8ee1f84-fc0f-4d21-a56f-72e4f93f91c4: A; edirom_source_947bf706-3c36-41fd-9f09-5b995d067a74: B :)
                                                        (: Giselle: opera_source_af56ff93-664f-4df2-817c-5ad6d826e850, A; opera_source_c5eee823-cac3-40c6-b99f-7cde64ebee15, B; opera_source_5f7c64af-0aca-48b8-bb4f-8e5b5b1741ed, C :)
                                                        else if (($participantSource/mei:mei/@xml:id = 'opera_source_af56ff93-664f-4df2-817c-5ad6d826e850' or $participantSource/mei:mei/@xml:id = 'opera_source_c5eee823-cac3-40c6-b99f-7cde64ebee15' or $participantSource/mei:mei/@xml:id = 'opera_source_5f7c64af-0aca-48b8-bb4f-8e5b5b1741ed') and contains($connectionParticipantNo, '+'))
                                                        then (
...
(:                                                        return $row:)
                                                        ...
                                                        let $connectionParticipantNos := $rowT[position() > 5 and position() < 10]
...
(:                                                                attribute mdiv { $mdiv },:)
                                ...
                                (: Steffani ME scene/text line :)
                                (:element concordance {
                                    attribute name {'Navigation by scene / text line (ME)'},
                                    element groups {
                                            ...
                                            element connections {
                                                ...
                                                for $row in $concRawData[position() > 1]
                                                    ...
                                                    let $plist := for $connectionParticipantNo at $pos in $connectionParticipantNos
                                                                    ...
                                                                    return
(\:                                                                        concat('[', $pos, '__', $participantSource//mei:identifier[@type='siglum'], '__', $connectionParticipantNo, ']'):\)
(\:                                                                        $participantSource//mei:identifier[@type='siglum']:\)
                                                                        local:getConectionPlistParticipantString($participantSource, $mdiv, $connectionParticipantNo, $connectionType)
                                                        return
                                                            element connection {
(\:                                                                attribute bla {$connectionParticipantNos},:\)
                                                                attribute name {$connectionNo},
                                                                attribute plist {$plist}
                                                                }
                                            }
